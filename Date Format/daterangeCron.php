...
include '/home/indiamart/public_html/10into/web/S3.php';

if($domain=='stg-serve.10times.com')    
    $storage_server= "stg-manage.10times.com";  
else if($domain=='serve.10times.com')
    $storage_server="gifbt.s3.amazonaws.com/manage";   
else
    $storage_server="local-manage.10times.com";
...
//Without Year
      ...
      if($st_mn==$en_mn)
            $format[124] = $st_OrdDt." - ".$en_OrdDt." ".$st_mn_f.", ".$en_yr;
      if($st_mn==$en_mn)
            $format[125] = $st_mn." ".$st_dt."/".$en_dt;
      if($st_mn==$en_mn)
            $format[126] = $st_mn.". ".$st_dt."/".$en_dt;
      if($st_mn==$en_mn)
            $format[127] = $st_dt.".".$st_mn.".".$en_dt."-".$en_dt0;
      if($st_mn==$en_mn)
            $format[128] = $st_OrdDt."-".$en_OrdDt." ".$en_mn_f;
      if($st_mn==$en_mn)
            $format[129] = $st_day_f.", ".$st_mn_f." ".$st_dt." – ".$en_day_f.",".$en_mn_f." ".$en_dt;
      $format[130] = "Start: ".$st_mn_f." ".$st_dt0;
      $format[131] = "End: ".$en_mn_f." ".$en_dt0;
      if($st_mn==$en_mn)
            $format[132] = $st_dt.". - ".$en_dt.". ".$en_mn_f;
      if($st_mn==$en_mn)
            $format[133] = $st_OrdDt." - ".$en_OrdDt." ".$en_mn_s.", ".$en_yr;
            $format[134] = $st_mn."/".$st_dt."/".$st_yr;
            $format[135] = $st_OrdDt." ".$st_mn_f;
            $format[136] = $st_OrdDt." ".$st_mn_f." ".$en_yr;
            $format[137] = $st_mn_s." ".$st_dt."/".$en_dt;
            $format[138] = $st_mn_s.". ".$st_dt;
            $format[139] = $st_mn_s." ".$st_dt;
            ...
            $format[151] = $st_day_f." ".$st_OrdDt." ".$st_mn_f;
            $format[152] = $st_OrdDt." ".$st_mn_f." ".$st_yr;
            $format[153] = $st_OrdDt." ".$st_mn_s." / ".$en_OrdDt." ".$en_mn_s." ".$en_yr2;
            $format[154] = $st_mn_f." ".$st_dt.", ".$en_yr;
            $format[155] = $st_OrdDt." - ".$en_OrdDt." ".$st_mn_f.", ".$en_yr;
            $format[156] = $st_OrdDt." - ".$en_OrdDt." ".$st_mn_f." ".$en_yr;
            $format[157] = $st_OrdDt." and ".$en_OrdDt." ".$st_mn_f." ".$en_yr;
            $format[158] = $st_mn_f." ".$st_dt0."-".$en_dt0.", ".$en_yr;
            $format[159] = $st_OrdDt." - ".$en_OrdDt." ".$st_mn_s." ".$en_yr;
            $format[160] = $st_dt." and ".$en_dt." ".$st_mn_f." ".$en_yr;
            $format[161] = $st_OrdDt." - ".$en_OrdDt." ".$st_mn_f." ".$en_yr;
            $format[162] = $st_day_f.", ".$st_dt." ".$st_mn_s.", ".$en_yr;
            $format[163] = $st_day_s." ".$st_mn_s." ".$st_dt.", ".$en_yr;
            $format[164] = $st_mn_s.". ".$st_dt."-".$en_dt.", ".$en_yr;
            $format[165] = $st_mn_s." ".$st_dt." & ".$en_dt.", ".$en_yr;
            $format[166] = $st_dt."-".$st_mn_s." to ".$en_dt."-".$en_mn_s."-".$en_yr;
            $format[167] = $st_mn_s." ".$st_dt.",".$en_dt;
            $format[168] = $st_dt.".".$st_mn.".".$st_yr2." - ".$en_dt.".".$en_mn.".".$en_yr2;
            $format[169] = $st_mn.".".$st_dt.".".$st_yr2." - ".$en_mn.".".$en_dt.".".$en_yr2;
            $format[170] = $st_dt." ".$st_mn_f." ".$st_yr;
            $format[171] = $st_OrdDt."&nbsp;".$st_mn_f." ".$en_yr;
            $format[172] = $st_dt."<sup>".date('S', strtotime($start_date))."</sup> ".$st_mn_s.", ".$st_yr;
            $format[173] = $st_dt."<sup>".date('S', strtotime($start_date))."</sup> ".$st_mn_s." ".$st_yr;
            $format[174] = $st_dt."<sup>".date('S', strtotime($start_date))."</sup> ".$st_mn_f.", ".$st_yr;
            $format[175] = $st_dt."<sup>".date('S', strtotime($start_date))."</sup> ".$st_mn_f." ".$st_yr;
            $format[176] = $st_dt0." to ".$en_dt0." ".$en_mn_f." ".$en_yr;
            $format[177] = $st_mn_f." ".$st_dt."-".$en_dt;
            $format[178] = $st_day_f.", ".$st_dt." ".$st_mn_s.", ".$st_yr;
            $format[179] = $st_day_s." ".$st_mn_s." ".$st_dt.", ".$st_yr;
            $format[180] = $st_OrdDt." &amp; ".$en_OrdDt." ".$st_mn_f;
            $format[181] = $st_mn_s."t. ".$st_dt."-".$en_dt.", ".$st_yr;
            $format[182] = $st_dt." – ".$en_dt." ".$st_mn_f." ".$en_yr;
            $format[183] = $st_mn_f." ".$st_dt.", ".$st_yr;
            $format[184] = $st_dt0." ".$st_mn_f." ".$st_yr;
            $format[185] = $st_dt."-".$st_mn_s." to ".$en_dt."-".$st_mn_s."-".$st_yr;
            $format[186] = $st_mn.".".$st_dt.".".$st_yr2;
            $tmp="";
      if($en_dt-$st_dt >= 1 && $st_mn==$en_mn)
      {
            for ($i=1; $i <($en_dt-$st_dt) ; $i++) {
            ...
            $format[187] = $st_OrdDt.$tmp.", ".$en_OrdDt." ".$st_mn_f." ".$en_yr;
      }
            $format[188] = $st_OrdDt."-".$en_OrdDt." ".$st_mn_f.", ".$st_yr;
            $format[189] = $st_mn_f." ".$st_dt."-".$en_dt.", ".$st_yr;
            $format[190] = $st_dt." ".$st_mn_s." ".$st_yr;
            $format[191] = $st_mn_f." ".$st_dt.", ".$st_yr;
            $format[192] = $st_mn_s." ".$st_dt.", ".$st_yr;
      ...
      // make for loop for push array format; Check for "" for Empty values not to push;
        ...
        foreach ($format as $key => $value) { 
            if(!empty($format[$key]))
            {
                  if(stripos($Wval, $format[$key]) !== false)
                    {$dateFound=1;break;}
            }
      }
        if($dateFound!=1)
...
$hitData['path'] = '/csv/Previous_Day_Publish_events.tsv';
  // $hitData['type'] = "w";
  // $hitData['fileType'] = "tsv";
  $hitData['data'] =$csv_data;
  $mail = file_write($hitData,$domain);
print_r($mail);
...
$email=array('apoorva@10times.com','sharad@10times.com','rajkumar@10times.com');
      ...
      $senddata['subject'] = "Event Date Reverification (Published on ".$day.")";
      ...
      $senddata['fileurl'][0]['path']='https://'.$storage_server.$hitData['path'];
      $senddata['fileurl'][0]['new_name']='Previous_Day_Publish_events.tsv';
...
function file_write($data,$domain)
  {
      if($domain=='serve.10times.com')
      {
        $requestHeaders = array();
        $requestHeaders['Cache-Control'] = 'max-age=315360000';
        $requestHeaders['Expires'] = gmdate("D, d M Y H:i:s T", strtotime("+1 year"));

        $s3 = new S3('AKIAIEW2PE2TNNMTW5TA', 'hWeBPdbkLPSuYEwANGWz4Ft94RgLa6WrMXaKEwUO');

        $file_name=end(explode("/", $data['path']));
        file_put_contents('/tmp/'.$file_name, $data['data']);
  
        if (!$s3->putObjectFile('/tmp/'.$file_name, 'gifbt', 'manage'.$data['path'], S3::ACL_PUBLIC_READ, array(), $requestHeaders ))
        {
      ...
      {
        $path="/home/indiamart/public_html/10into/web".$data['path'];
        if(!is_dir(implode('/', explode('/', $path, -1))))
          if(!mkdir(implode('/', explode('/', $path, -1)),0777,true))
          {
            $status['status']['message'][]='Sorry! directory creation is not possible';
