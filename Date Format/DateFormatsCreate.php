...
$header1 ="";
$timeout = 30000;
// $append.="<html><body><table border='1' width='100%' >";
// $append.="<thead><td>Id</td><td>Website</td><td>Start</td><td>End</td><td>Status</td></thead>";
$filename ="Book1.txt";
// $fp = @fopen($filename, 'r'); 
$array = array();
$formats = array();
...
//Without Year
      ...
      if($en_dt-$st_dt >= 1 && $st_mn==$en_mn)
      {
            ...
            $format[191] = $st_mn_s." ".$st_dt.", ".$st_yr
;
    // list of Date formats;
        $dateFound = 0;
        // echo count($format)."A<br>";
      for ($formatArr=0; $formatArr < count($format) ; $formatArr++) 
       { 
            if(!empty($format[$formatArr]))
            {
                // array_push($formats,$format[$formatArr]);
                echo $format[$formatArr]."\n";
            }
        }
 ...
 //            if(!empty($format[$formatArr]))
 //            {
 //                 $x = stripos($Wval, $format[$formatArr]);
 //                 if($x !== false)
 //                    {$dateFound=1;
 //                    	$csv_data =$format[$formatArr];
 //                    		break;}
 //            }
 //        }
	...
	// $append.="<tr><td>".$id[0]."</td>";
 //    $append.="<td><a href='".$id[2]."'>".$id[2]."</a></td>";
 //    $append.="<td>".$id[3]."</td>";
 //    $append.="<td>".$id[4]."</td>";
 //    $append.="<td>".$csv_data."</td>";
